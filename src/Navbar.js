...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-900 py-4 px-6 flex justify-between items-center">
      <div className="text-white text-xl font-bold">Alpha Store</div>
      <div className="text-gray-300 flex items-center">
        <span className='font-bold'>Balance:&nbsp;</span> <span className='text-green-500 font-bold'>787</span>&nbsp;Alpha coins
